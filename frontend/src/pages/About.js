  ...
  return (
    <div className="homepage">
      ...
      <div className="optimize">
        <h1 className="heading">Welcome To Content Craft!</h1>
        <p className="content">
          At <i>MyInscribe Digital Private Limited</i>, we are transforming the content creation landscape with our cutting-edge AI-Based Content Workflow Automation system. 
